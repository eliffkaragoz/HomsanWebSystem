...
<link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
	...
	<script src="ajax_employee.js"></script>
...
<p id="success"></p>
	<div class="table-wrapper">
		...
		<div class="col-sm-7">
					<a href="#addProductModal" class="btn btn-info btn-lg" data-toggle="modal"> <span>Yeni Ürün Ekle</span></a>
				</div>
		<table class="table">
			...
			<tr id="<?php echo $row["id"]; ?>">
				...
				<td>
					...
					<a href="#deleteProductModal" class="delete" data-id="<?php echo $row["id"]; ?>" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" 
						title="Delete"></i></a>
				</td>
			</tr>
			<?php
			...
			<form id="user_form">
				...
				<div class="modal-body">					
					...
					<div class="form-group">
						...
						<input type="surname" id="price" name="price" class="form-control" required>
					</div>
